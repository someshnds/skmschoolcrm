    ...
    <div>
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none" v-if="checkPermission('expense-type-create')">
                    <div class="d-flex">
        ...
        <div class="row row-cards mt-2">
            <template v-if="expenseTypes && expenseTypes.length">
                <div class="col-md-4 col-xl-3" v-for="type in expenseTypes" :key="type.id">
                    <div class="card">
                ...
                <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                    <div class="modal-content" v-on-clickaway="reset">
                        <div class="modal-header">
                            ...
                            <h5 v-else class="modal-title">{{ $t("update_type") }}</h5>
...
<script>
    ...
    export default {
            ...
            async save() {
                try {
                    if (!this.isEditMode) {
                        let {
                            data
                        } = await this.form.post("/api/expensetypes", {
                            transformRequest: [
                        ...
                        let {
                            ...
                            `/api/expensetypes/${this.selectedId}/update`, {
                                transformRequest: [
                                    function (data, headers) {
                                        return serialize(data);
                                    },
                        ...
                        this.$store.commit("expense/UPDATE_EXPENSE_TYPE", data.expensetype);
                        this.toastSuccess(data.message);
                        this.reset();
                    }
                } catch (err) {
        ...
        async created() {
            await this.hasPermisssion("expense-type-list");
